...
async def echo(bot, update):
    if update.from_user.id in Config.AUTH_USERS:
        ...
        if e_response and "nonnumeric port" not in e_response:
            ...
            error_message = e_response.replace("please report this issue on https://yt-dl.org/bug . Make sure you are using the latest version; see  https://yt-dl.org/update  on how to update. Be sure to call yt-dlp with the --verbose flag and include its complete output.", "")
