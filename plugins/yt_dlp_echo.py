...
async def echo(bot, update):
    ...
    if e_response and "nonnumeric port" not in e_response:
        ...
        error_message = e_response.replace("Please report this issue on https://github/yt-dlp/yt-dlp.Make sure you are using the latest version; see  https://github/yt-dlp/yt-dlp on how to update. Be sure to call You are Using Latest yt-dlp package.", "")
